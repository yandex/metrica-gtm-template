...

{
  ...
  "description": "This template adds the Metrica Tag to your website. To ensure better analytics, trigger it during initialization. By using Metrica through this template you agree with Yandex Metrica terms of use https://yandex.com/legal/metrica_termsofuse",
  "categories": [
    "ANALYTICS",
    "ATTRIBUTION",
    "CONVERSIONS",
